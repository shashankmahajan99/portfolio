...
export const portfolioData: PortfolioData = {
  ...
  skills: [
    ...
    { name: "React.js", level: "Proficient", category: "Frontend", experience: "4+ years" },
    ...
    { name: "MySQL", level: "Skilled", category: "Database", experience: "3+ years" },
    { name: "CI/CD (GitLab/Bamboo)", level: "Expert", category: "DevOps", experience: "4+ years" },
    { name: "CTF (Cybersecurity)", level: "Skilled", category: "Security", experience: "2+ years" },
  ],
  projects: [
    {
      title: "HSMs Manager",
